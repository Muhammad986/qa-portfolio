...
class BasePage:
    ...
    @allure.step('Find element visible without scroll')
    def find_is_visible_no_scroll(self, locator, timeout=5):
        return wait(self.driver, timeout).until(EC.visibility_of_element_located(locator))

    @allure.step('Find element invisible')
    ...
    @allure.step('Scroll to page bottom')
    ...
    @allure.step('Scroll to page top')
    def action_move_to_element(self, element):
        action = ActionChains(self.driver)
        action.move_to_element(element).perform()

    @allure.step('Click and switch to new window')
    ...
    @allure.step('Click and handle alert')
