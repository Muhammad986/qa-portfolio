...
class CheckBoxPage(BasePage):
    ...
    @allure.step('Normalize text items')
...
class UploadAndDownloadPage(BasePage):
    ...
    @allure.step('Check file download')
    ...
    @allure.step('Delete downloaded file')
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_appear_button(self):
        try:
            self.find_is_visible_no_scroll(self.locators.VISIBLE_AFTER_BUTTON, timeout=7) is not None
